 ...
 * @author PC_LENOVO
 */
@FacesConverter(value = "converterMoneySaldoBase")
public class ConverterMoneySaldoBase implements  Serializable,Converter{
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
             ...
             String retorno =Utils.converterToMoneySaldoBase(o.toString());
